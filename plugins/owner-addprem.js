...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (now < global.db.data.users[hl[0]].premiumTime) global.db.data.users[hl[0]].premiumTime += jumlahHari
  else global.db.data.users[hl[0]].premiumTime = now + jumlahHari
